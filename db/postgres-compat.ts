...
// Supabase Free usa un pool transaccional. Una sola conexión por función evita
// saturar el cupo al cargar en paralelo todos los módulos del panel móvil.
const sqlClient=()=>client??=(postgres(process.env.POSTGRES_URL!,{
  ssl:"require",
  max:1,
  connect_timeout:10,
  idle_timeout:20,
