...
export default function ProductsPage(){return <main className="pb-site"><VerificationGate/><SiteHeader/>
  ...
  <footer><p><b>Peptibra · Peptide Depot</b></p><p>Catálogo informativo para fines de investigación.</p><a href="mailto:info@peptibra.com">Solicitar información</a></footer>
</main>}
