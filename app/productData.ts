export type CatalogProduct = {
  ...
  cap: string;
  format: string;
  status: "Disponible" | "Disponibilidad limitada";
...
export const products: CatalogProduct[] = [
  {
    slug: "wolverine", name: "Wolverine", dose: "10 mg", category: "Recovery Blend", image: "/products/wolverine-10mg.png", cap: "Gris", format: "Polvo liofilizado", status: "Disponible", coaStatus: "Documentación en revisión",
  ...
  {
    slug: "mots-c", name: "MOTS-c", dose: "10 mg", category: "Metabolic Research", image: "/products/mots-c-10mg-final.png", cap: "Verde", format: "Polvo liofilizado", status: "Disponible", coaStatus: "Documentación disponible",
  ...
  {
    slug: "ghk-cu", name: "GHK-CU", dose: "100 mg", category: "Copper Peptide", image: "/products/ghk-cu-100mg-navy.png", cap: "Roja", format: "Polvo liofilizado azul marino", status: "Disponibilidad limitada", coaStatus: "Documentación disponible",
  ...
  {
    slug: "tirzepatide", name: "Tirzepatide", dose: "20 mg", category: "Metabolic Research", image: "/products/tirzepatide-20mg.png", cap: "Negra", format: "Polvo liofilizado", status: "Disponible", coaStatus: "Documentación en revisión",
  ...
  {
    slug: "glp3-reta", name: "GLP-3 Reta", dose: "20 mg", category: "Triple Receptor Research", image: "/products/glp3-reta-20mg.png", cap: "Marrón", format: "Polvo liofilizado", status: "Disponible", coaStatus: "Documentación en revisión",
